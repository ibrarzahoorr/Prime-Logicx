      ...
      <div className="bg-background pt-32 pb-24 sm:pt-40 sm:pb-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-12 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {allBlogs.map((post) => (
              <article key={post.id} className="flex flex-col items-start justify-between bg-white/5 p-6 rounded-2xl border border-white/10 hover:border-accent/50 transition-colors">
                ...
                <div className="group relative">
                  <h3 className="mt-3 text-lg font-semibold leading-6 text-white group-hover:text-accent font-sora">
